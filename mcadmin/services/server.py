...
class ServerService:
    def __init__(self, *, mc_server_runner: McServerRunner, mc_world_manager: McWorldManager):
    ...
    async def rcon_connect(self) -> AsyncIterator[Callable[[str], Awaitable[str]]]:
        connect_info = self._mc_world_manager.get_rcon_connect_info()
    ...
    def get_server_connect_info(self) -> dict:
        return self._mc_world_manager.get_server_connect_info()
